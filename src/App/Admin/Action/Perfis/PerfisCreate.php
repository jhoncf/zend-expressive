...
use App\Admin\Entity\UserProfiles;
...
class PerfisCreate {
	...
	/**
	 * @api {post} /api/Admin/Perfis/:id Adicionar Perfil
	 * @apiName AdminPerfilCreate
	 ...
	 *     }:
	 *
	 * @apiError AdminPerfilNotInserted The AdminPerfil could not be created.
	 *
	 ...
	 *          "detail": "Não foi possível cadastrar a Perfil",
	 *          "links": {
