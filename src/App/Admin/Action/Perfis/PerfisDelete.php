...
class PerfisDelete {
	...
	/**
	 * @api {delete} /api/Admin/Perfis/:id Remover Perfil
	 * @apiName PerfisDelete
	 ...
	 *          "detail": "Não foi possível Remover o Perfil",
	 *          "links": {
	...
	public function __invoke(CustomRequest $request, ResponseInterface $response, callable $next = null) {
		...
		return new JsonResponse(['message' => 'success', 'error' => false]);
	}
}