...
use Business\Produtos\Action\ProdutosAction;
use Business\Produtos\Action\ProdutosCreate;
use Business\Produtos\Action\ProdutosDelete;
use Business\Produtos\Action\ProdutosRead;
use Business\Produtos\Action\ProdutosUpdate;
...
class ProdutosTest extends TestCase {
	...
	public function testCreateProduto() {
		$action = new ProdutosCreate($this->container->get(EntityManager::class));
	...
	public function testListProduto() {
		$action = new ProdutosAction($this->container->get(EntityManager::class));
	 ...
	 */
	public function testGetIdProduto($postData) {
		$action = new ProdutosRead($this->container->get(EntityManager::class));
		...
		$this->assertEquals($postData['url'], $responseArray['result']['url']);
	 ...
	 * @depends testCreateProduto
	 */
	public function testEditProduto($postData) {
		$action = new ProdutosUpdate($this->container->get(EntityManager::class));
		...
		$putData = [
			...
			'url' => '123Editado',
			'slug' => 'produto_testeEditado',
			'imageUrl' => 'nullEditado',
			'order' => 0
		];
	 ...
	 * @depends testCreateProduto
	 */
	public function testDeleteProduto($postData) {
		$action = new ProdutosDelete($this->container->get(EntityManager::class));
